                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="signatureForm" method="POST" enctype="multipart/form-data"
                                    ...
                                    {{-- Preview gambar jika sedang edit --}}
                                    <div class="form-group" id="previewQrcodeContainer" style="display: none;">
                                        <label>QR Code Saat Ini</label><br>
                                        <img id="previewQrcode" src="" width="50">
                                    </div>

                                    <div class="form-group" id="previewTtdContainer" style="display: none;">
                                        <label>TTD Saat Ini</label><br>
                                        <img id="previewTtd" src="" width="50">
                                    </div>
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                                ...
                                                <td>
                                                    @if (auth()->id() == $d->user_id)
                                                        <a href="javascript:void(0)" class="btn btn-primary btn-edit"
                                                            ...
                                                            data-nip="{{ $d->nip }}" data-nik="{{ $d->nik }}"
                                                            data-ttd="{{ $d->ttd }}"
                                                            data-qrcode="{{ $d->qrcode }}">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            <form
                                                                action="{{ route('signature.delete', ['id' => $d->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                        ...
                                        @if ($signatures->count() == 0)
                                            <tr>
                                                <td colspan="7" class="text-center text-muted">Belum ada data tanda
                                                    tangan.</td>
                                            </tr>
                                        @endif
                                    </tbody>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.btn-edit').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    if (qrcode) {
                        document.getElementById('previewQrcodeContainer').style.display = 'block';
                        document.getElementById('previewQrcode').src = `/storage/${qrcode}`;
                    }

                    // Tampilkan preview TTD
                    if (ttd) {
                        document.getElementById('previewTtdContainer').style.display = 'block';
                        document.getElementById('previewTtd').src = `/storage/${ttd}`;
                    }
                });
            });
            ...
            document.getElementById('resetBtn').addEventListener('click', function() {
                ...
                // Sembunyikan preview
                document.getElementById('previewQrcodeContainer').style.display = 'none';
