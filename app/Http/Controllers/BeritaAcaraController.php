...
public function update(Request $request, $id)
{
    ...
    // Update file dokumentasi jika ada upload baru
    if ($request->hasFile('dokumentasi')) {
        $fileName = $request->file('dokumentasi')->store('dokumentasi', 'public');
        $berita->dokumentasi = $fileName;
    }

    // Update file tanda tangan WP jika ada upload baru
   ...
   public function cetak($id)
{
    ...
    // Ambil user yang memiliki role 'kasi' dan 'kabid' langsung dari tabel users
